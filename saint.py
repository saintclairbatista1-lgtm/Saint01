...
app = FastAPI(
    ...
    version="2.9.0",
    description="API blindada com microprocessador de 500 bytes, biometria e carteira multimoeda (SDC, SDT, USD_DIGITAL, EUR_DIGITAL, BRX) via SQLite"
)
...
# Ativos suportados oficiais com o BRX (Real Digital) integrado
